document.getElementById('barcodeStarter').addEventListener('click', function () {
    document.getElementById('barcode_container').style.display = "block";
    document.getElementById('barcodeStarter').style.display = "none";
    $(function () {
